...
CREATE TABLE IF NOT EXISTS `" . TABLE_PREFIX . "mod_forum_settings` (
	...
	`FORUM_ADMIN_INFO_ON_NEW_POSTS` varchar(180) COLLATE utf8_unicode_ci,
	`FORUM_MAIL_SENDER` varchar(180) COLLATE utf8_unicode_ci,
	`FORUM_MAIL_SENDER_REALNAME` varchar(180) COLLATE utf8_unicode_ci,
